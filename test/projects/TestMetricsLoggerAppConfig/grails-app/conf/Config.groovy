...
grails.plugin.metricslogger.requestHeadersForLogging = ['X-Forwarded-For', 'X-Teros-Client-IP']
...
log4j = {
    ...
    //}
    appenders {
        console name:'mainAppender', layout:pattern(conversionPattern: '%d{dd,MM HH:mm:ss:SSS} [%t] %-5p %c{2} - %m%n')
